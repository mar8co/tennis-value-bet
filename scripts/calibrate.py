"""CLI: fit and validate the output-recalibration (temperature) layer for the
serve/return match-winner model.

    python scripts/calibrate.py --tour atp
...
def main() -> None:
    ap = argparse.ArgumentParser(
        description="Fit/validate the recalibration layer.")
    ...
    print(f"=== RICALIBRAZIONE modello servizio/risposta - {args.tour.upper()} ===")
    ...
    print("(la temperatura non cambia l'accuratezza: trasformazione monotona)\n")
